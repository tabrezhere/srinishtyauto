<%@ Page Title="Services of SML ISUZU" Language="C#" AutoEventWireup="true" CodeFile="Services.aspx.cs" Inherits="Services" %>
...
<head>
    ...
    <title>Services of SML ISUZU</title>
    <!-- Bootstrap core CSS -->
                            ...
                            <div class="col-lg-5">
                                <div class="col-lg-9">
                                    <div class="logo-footer">
                                        <img src="images/sna_transCopy.png" /></div>
                                </div>
                                <div class="logo-footer">
                                    <a href="#">
                                        <h1>Sri Nisty</h1>
            ...
            <div class="row">
                <div class="consider padding-bottom-40 clearfix">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 padding-left-none xs-padding-bottom-40">
                        <h3>Drive Joy from Excellence</h3>
                        <div class="left-content padding-top-20">
                            <p style="line-height: 30px"><span class="firstcharacter">W</span>e at Sri Nisty Automotives believe “Everything starts with the right advice” the focus is on customer satisfaction, our expert mechanics trained by SML ISUZU will take care of your vehicle, we provide support with professional advice that covers everything down to the smallest detail, you can expect 100% peace of mind with SML ISUZU Genuine Spares, on time delivery of service with quality is our prime motto.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 things_to_consider padding-right-none xs-padding-left-none">
                        ...
                        <div class="right-content">
                            <ul>
                                ...
                                <li>Custom building of special purpose vehicles [SPVs]</li>
                                <li>Repair of accident vehicles</li>
