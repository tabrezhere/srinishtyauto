<%@ Page Title="" Language="C#"  AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="Sartaj59xm.aspx.cs" Inherits="Sartaj59xm" %>
            ...
            <div class="inventory-heading margin-bottom-10 clearfix">
                <div class="row">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <h2>Sartaj 59 XM </h2>
                        <span class="margin-top-10">More load per liter</span> </div>
				</div>
                </div>
                ...
                <div class="row">
                    ...
                    <ul>
                      ...
                      <%--  <li class="schedule gradient_button"><a href="forms/schedule.php?recaptcha" class="fancybox_div">Schedule Test Drive</a></li>--%>
                        <li class="pdf gradient_button"><a href="PDF_Broucher/Sartaj_59_xm.pdf" target="_blank" class="">PDF Brochure</a></li>
                        <li id="email" class="email gradient_button"><a id="A1" href=""  runat="server" onclick="function();" >Email to a Friend</a></li>
                        <li class="next1 gradient_button"><a href="Sartaj">Next Vehicle</a></li>
                    </ul>
                          </div>
                    <div class="col-md-3">
                    <h4>Sartaj59XM </h4></div>
                </div>
            </div>
            <div class="row">
                ...
                <tr>
                  ...
                  <td colspan="3" class="fontBody">2815</td>
                 
                </tr>
                <tr>
                  <td class="fontBody">Min. Turning    Circle Diameter in m</td>
                  <td colspan="3" class="fontBody">11</td>
                 
                </tr>
               
                <tr>
                  <td class="fontBody">Max.Permissible GVW (Kg)</td>
                  <td colspan="4" class="fontBody">5990</td>
                </tr>
                    <tr>
                  <td class="fontBody">Cab fixed Deck</td>
                  <td class="fontBody" colspan="2">3510 x 1880 x 580</td>
                         <td class="fontBody" colspan="2">3510 x 1880 x 580</td>
                        </tr>
                <tr>
                  <td class="fontBody">Cab Semi Deck</td>
                  <td class="fontBody" colspan="2">&nbsp</td>
                  <td class="fontBody" colspan="2">&nbsp</td>
                </tr>
                <tr>
                  <td class="fontBody">Cab High Deck</td>
                   <td class="fontBody" colspan="2">3510 x 1880 x 1695</td>
                   <td class="fontBody" colspan="2">3510 x 1880 x 1695</td>
                  
                </tr>
                      <tr>
                  <td class="fontBody">Load Span(ft.)</td>
                   <td class="fontBody" colspan="2">11.5'</td>
                          <td class="fontBody" colspan="2">11.25'</td>
                          </tr>
                <tr>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 right-content padding-right-none">
                    <div class="side-content">
                        <div class="padding-vertical-15 margin-bottom-40">
                         <img class="img-responsive" src="My_images/Trucks/sartaj59-1.jpg" alt="">
                        </div>
