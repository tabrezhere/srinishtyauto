<%@ Page Title="Contact us, Gulbarga" Language="C#"  AutoEventWireup="true" CodeFile="Contact.aspx.cs" Inherits="Contact" %>
            ...
            <div class="container">
              ...
              <span> Automotives </span></a></div>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <%--<a class="navbar-brand" href="Home.aspx"><span class="logo"><img src="images/logo.png"></span></a>--%>
                        </div>
                        <!-- /.navbar-collapse -->
            ...
            <div class="inner-page">
                <div class="col-md-12 padding-none">
                    ...
                    <div class="col-md-6 left-information">
                        <div class="contact_information information_head clearfix">
                            ...
                            <div class="address clearfix margin-right-25 padding-bottom-40">
                                ...
                                <div class="contact_address">
                                    <p class="margin-bottom-none">Sri Nisty Automotives <br>
										 126/1, Humnabad Ring Road&nbsp&nbsp  &nbsp <br>
										  Opposite KMF Milk Dairy<br>
										Gulbarga - 585104</p>
                                </div>
                            </div>
                            <div class="address clearfix address_details margin-right-25 padding-bottom-40">
                                <ul class="margin-bottom-none">
                                    <li><i class="fa fa-phone"></i><strong>Phone:</strong> <span>+(91)-97408 84999, 08472-220282, 220113</span></li>
                                    <li><i class="fa fa-envelope-o"></i><strong>Email:</strong> <a href="">sales@srinistyauto.in</a></li>
                                    <li class="padding-bottom-none"><i class="fa fa-laptop"></i><strong>Web:</strong> <a href="http://www.srinistyauto.in">www.srinistyauto.in</a></li>
                                </ul>
                            </div>
                        </div>
                        <!--INFORMATION HOUR-->
                        ...
                        <!--RIGHT INFORMATION-->
                         <div class="col-md-5 padding-right-none xs-padding-left-none sm-padding-left-none xs-margin-top-30">
                                     ...
                                     <fieldset id="contact_form" runat="server">
                                         <form runat="server" >
                                             <table >
                                                 <tr>
                                                     <td>
                                                     <asp:textbox id="txtname" runat="server" class="form-control margin-bottom-25" placeholder="Name  (Required)" required></asp:textbox>
                                             <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="*Enter Only Characters" ControlToValidate="txtname" Display="Static" ForeColor="Red" ValidationExpression="^[a-zA-Z\s]*$"></asp:RegularExpressionValidator>
                                                 ...
                                                 <tr>
                                                     <td>
                                                     <asp:textbox id="txtemail" runat="server" class="form-control margin-bottom-25" placeholder="Email  (Required)" required></asp:textbox>
                                             <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ForeColor="Red" ErrorMessage="Please enter valid Email ID" Display="Static" ControlToValidate="txtemail" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w{2,6}|([-.]\w+)"></asp:RegularExpressionValidator>
                                                 ...
                                                 <tr>
                                                     <td>
                                                           <asp:textbox id="txtmsg" runat="server" class="form-control margin-bottom-25" textmode="MultiLine" placeholder="Your message  (Required)" required></asp:textbox>
                                                     </td>
                                                 </tr>
                                                 <tr>
                                                     <td>
                                                         <asp:textbox id="txtcontact" runat="server" class="form-control margin-bottom-25" placeholder="Contact Number (Required)" required></asp:textbox>
                                             ...
                                             <asp:button id="btnrequestcall" runat="server" text="Request Call Back" OnClick="btnrequestcall_Click" />
                                                     </td>
                                                 </tr>
                                             </table>
    ...
    <!--MAP-->
                    <div class="find_map row clearfix">
                        ...
                        <div class="map margin-vertical-30">
                            ...
                            <iframe id='google-map-listing' data-longitude='-79.38' data-latitude='43.65' data-zoom='8' style='height: 390px;' data-scroll='false' data-style='[{"featureType":"landscape","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"transit","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"poi","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"water","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"road","elementType":"labels.icon","stylers":[{"visibility":"off"}]},{"stylers":[{"hue":"#F0F0F0"},{"saturation":-100},{"gamma":2.15},{"lightness":12}]},{"featureType":"road","elementType":"labels.text.fill","stylers":[{"visibility":"on"},{"lightness":24}]},{"featureType":"road","elementType":"geometry","stylers":[{"lightness":57}]}]' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d891.133440475543!2d76.84608823156296!3d17.360257904820457!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x129a092447ac7f4f!2sSri+Nisty+Automotives!5e1!3m2!1sen!2sin!4v1481886805616" width="1350" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
                    </div>
                    <!--MAP-->
    <!--content ends-->
...
<script type="text/javascript" src="js/jquery.easing.js"></script></html>
