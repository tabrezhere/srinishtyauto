<%@ Page Title="" Language="C#"  AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="S7_Staff.aspx.cs" Inherits="S7_Staff" %>
            ...
            <div class="inventory-heading margin-bottom-10 clearfix">
                <div class="row">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <h2>S7 Staff Bus </h2>
                        <span class="margin-top-10">Where Executive Travel is a Pleasure</span> </div>
            ...
            <div class="content-nav margin-bottom-30">
                <div class="row">
                    ...
                    <ul>
                        ...
                        <li class="pdf gradient_button"><a href="PDF_Broucher/S7_Staff_Bus.pdf" target="_blank" class="">PDF Brochure</a></li>
                         <li id="email" class="email gradient_button"><a id="A1" href=""  runat="server" onclick="function();" >Email to a Friend</a></li>
                        <li class="next1 gradient_button"><a href="Prestigious">Next Vehicle</a></li>
                    </ul>
                         </div>
                    <div class="col-md-3">
                    <h4>S7 Staff Bus </h4></div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div id="myTabContent" class="tab-content margin-top-15 margin-bottom-20">
                            <div class="tab-pane fade in active" id="features" >
                                ...
                                <ul class="fa-ul">
                                    ...
                                    <li><i class="fa-li fa fa-check"></i>Better Driver Cockpit</li>
                                    <li><i class="fa-li fa fa-check"></i>Larger Window Shield- Better Driving View.</li>
                                    <li><i class="fa-li fa fa-check"></i> Suitable located gear shift lever for Driver Comfort.</li>
                                    <li><i class="fa-li fa fa-check"></i>Tiltable and Telescopic Power Steering.</li>
                                    <li><i class="fa-li fa fa-check"></i> Peep Window - Better Driving.</li>
                                    <li><i class="fa-li fa fa-check"></i> Bigger rear view mirror.</li>
                                    <li><i class="fa-li fa fa-check"></i> Power Steering and Air Break for better control.</li>
                                    <li><i class="fa-li fa fa-check"></i> Improved Engine cover - Low cabin noise.</li>
                                    <li><i class="fa-li fa fa-check"></i> Wide Hatrack.</li>
                                    <li><i class="fa-li fa fa-check"></i>High Head Rest seats with Arm Rest for more Comfort.</li>
                                    <li><i class="fa-li fa fa-check"></i>Large Side Windows.</li>
                                     <li><i class="fa-li fa fa-check"></i>New Tubular Structure - Safe & Robust.</li>
                                     <li><i class="fa-li fa fa-check"></i>Box type Chassis Frame- High Durability.</li>
                                     <li><i class="fa-li fa fa-check"></i>Pleasing look.</li>
                                     <li><i class="fa-li fa fa-check"></i>Improved Tail lamp and rear fascia.</li>
                                     <li><i class="fa-li fa fa-check"></i>Improved Head lamps.</li>
                                     <li><i class="fa-li fa fa-check"></i>Side Emergency Door.</li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 right-content padding-right-none">
                    <div class="side-content">
                       <div class="padding-vertical-15 margin-bottom-40">
                         <img class="img-responsive" src="My_images/Resize_Buses/Staff_bus-3.png" alt="">
                        </div>
