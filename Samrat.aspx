<%@ Page Title="" Language="C#"  AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="Samrat.aspx.cs" Inherits="Samrat" %>
            ...
            <div class="inventory-heading margin-bottom-10 clearfix">
                <div class="row">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <h2>Samrat </h2>
                        <span class="margin-top-10">Strong Truck at Optimum Price</span> </div>
     ...
     <div class="modal fade" id="myModal" role="dialog">
            ...
            <div class="content-nav margin-bottom-30">
                <div class="row">
                    ...
                    <ul>
                        ...
                        <li class="pdf gradient_button"><a href="PDF_Broucher/Samrat 21.pdf" target="_blank" class="">PDF Brochure</a></li>
                        <li id="email" class="email gradient_button"><a href=""  runat="server" onclick="function();" >Email to a Friend</a></li>
            ...
            <div class="row">
                ...
                <col width="157">
                  ...
                  <td colspan="2" class="fontBody"><strong>SAMRAT    BS - III</strong></td>
                  <td width="149" class="fontBody"><strong>SAMRAT BS - IV</strong></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="3" class="fontBody">Mechanical / Power Steering    (Optional)</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="120" class="fontBody">3940</td>
                ...
                <tr>
                  ...
                  <td class="fontBody">3370</td>
                  <td class="fontBody">3370</td>
                  <td class="fontBody">3370</td>
                </tr>
                <tr>
                  <td class="fontBody">Rear Axle    Weight</td>
                  <td class="fontBody">6880</td>
                  <td class="fontBody">6880</td>
                  <td class="fontBody">6880</td>
                </tr>
                <tr>
                  <td class="fontBody">Kerb Weight</td>
                  <td class="fontBody">3420</td>
                  <td class="fontBody">3550</td>
                  <td class="fontBody">3350</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="3" class="fontBody">Available</td>
                </tr>
              </tbody></table>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 right-content padding-right-none">
                    <div class="side-content">
                       <div class="padding-vertical-15 margin-bottom-40">
                          <img class="img-responsive" src="My_images/Trucks/samrat_2.jpg" alt="">
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8 padding-right-none sm-padding-left-none xs-padding-left-none">
                        <div class="carasouel-slider3">
                            ...
                            <div class="slide">
                                <div class="car-block">
                                    <div class="img-flex"> <a href="Superme"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="My_images/Similar_trucks/supreme xm.jpg" alt="" class="img-responsive"> </div>
