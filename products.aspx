<%@ Page Title="Commercial Vehicles, Trucks,Buses" Language="C#"  AutoEventWireup="true" CodeFile="products.aspx.cs" Inherits="products" %>
...
<link rel="stylesheet" type="text/css" href="fonts/fonts_googleapis.css" rel="stylesheet" />
<title>Commercial Vehicles, Trucks,Buses
</title>
<!-- Bootstrap core CSS -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12 ">
                    <ul class="right-none pull-right company_info">
                        ...
                        <li class="address"><a href="Contact"><i class="fa fa-map-marker"></i><font size="2"> 126/1, Humnabad Ring Road, Opp KMF Milk Diary Gulbarga - 585104</font></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <nav class="navbar navbar-default" role="navigation">
              ...
              <span> Automotives </span></a></div>
                ...
                <span class="pull-right"><img src="images/logo.png"></span>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li><a href="About_Us">About Us </a>
                             ...
                             <li class="dropdown active"><a  href="Products" class="" >Products <b class="dropdown-toggle fa fa-angle-down" data-toggle="dropdown"></b></a>
...
<section class="content">
    <div class="container">
         <div class="inner-page portfolio-container row">
            <div class="portfolioContainer portfolio_2">
                <div class="col-md-6 col-sm-6 col-xs-12 convertible sports-car mix margin-bottom-30">
                    
                    <div class="box clearfix"> 
                        <a class="fancybox" href="Trucks"><img class="image" src="My_images/sliderimages/sartaj-hg-1.png " alt="" href="Trucks" /></a>
                                 <h4 class="porche-footer"><a href="Trucks"> Get Details of Trucks</a></h4>
                    </div>

                </div>
                <div class="col-md-6 col-sm-6 col-xs-12 coupe suv mix margin-bottom-30">
                    <div class="box clearfix"> <a class="fancybox" href="Buses"><img class="image" src="My_images/sliderimages/s7_new.png"   alt=""/></a> </div>
                      <h4 class="porche-footer"><a href="Trucks"> Get Details of Buses</a></h4>
                </div>
                    </div>
                </div>
                </div>
