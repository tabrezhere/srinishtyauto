<%@ Page Title="" Language="C#"  AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="Sartaj5252.aspx.cs" Inherits="Sartaj5252" %>
            ...
            <div class="inventory-heading margin-bottom-10 clearfix">
                <div class="row">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <h2>Sartaj 5252 XM </h2>
                        <span class="margin-top-10">Technology, Strength and Mileage</span> </div>
            ...
            <div class="content-nav margin-bottom-30">
                <div class="row">
                    ...
                    <ul>
                        ...
                        <li class="pdf gradient_button"><a href="PDF_Broucher/Sartaj_5252_xm.pdf" target="_blank" class="">PDF Brochure</a></li>
                       <li id="email" class="email gradient_button"><a id="A1" href=""  runat="server" onclick="function();" >Email to a Friend</a></li>
                        <li class="next1 gradient_button"><a href="Supreme">Next Vehicle</a></li>
                    </ul>
                         </div>
                    <div class="col-md-3">
                    <h4>Sartaj5252 </h4></div>
                </div>
            </div>
            <div class="row">
                ...
                <tr>
                  ...
                  <td colspan="4" class="fontBody">7' x 16' -14PR </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="3" class="fontBody">2515</td>
                 
                </tr>
                <tr>
                  <td class="fontBody">Min. Turning    Circle Diameter in m</td>
                  <td colspan="3" class="fontBody">10.15</td>
                 
                </tr>
               
                <tr>
                  <td class="fontBody">Max.Permissible GVW (Kg)</td>
                  <td colspan="2" class="fontBody">4990</td>
                    <td colspan="2" class="fontBody">5200</td>
                </tr>
                    <tr>
                  <td class="fontBody">Cab fixed Deck</td>
                  <td class="fontBody" colspan="2">2800 x 1860 x 400</td>
                         <td class="fontBody" colspan="2">2800 x 1860 x 400</td>
                        </tr>
                <tr>
                  <td class="fontBody">Cab Semi Deck</td>
                  <td class="fontBody" colspan="2">2800 x 1860 x 1030</td>
                  <td class="fontBody" colspan="2">2800 x 1860 x 1030</td>
                </tr>
                <tr>
                  <td class="fontBody">Cab High Deck</td>
                   <td class="fontBody" colspan="2">2800 x 1860 x 1695</td>
                   <td class="fontBody" colspan="2">2800 x 1860 x 1695</td>
                  
                </tr>
                      <tr>
                  <td class="fontBody">Load Span(ft.)</td>
                   <td class="fontBody" colspan="2">9.1'</td>
                          <td class="fontBody" colspan="2">9.1'</td>
                          </tr>
                <tr>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 right-content padding-right-none">
                    <div class="side-content">
                       <div class="padding-vertical-15 margin-bottom-40">
                          <img class="img-responsive" src="My_images/Trucks/Sartaj5252-2.jpg" alt="">
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8 padding-right-none sm-padding-left-none xs-padding-left-none">
                        <div class="carasouel-slider3">
                            ...
                            <div class="slide">
                                <div class="car-block">
                                    <div class="img-flex"> <a href="Samrat"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="My_images/Similar_trucks/samrat_6.jpg" alt="" class="img-responsive"> </div>
                                  
                                </div>
                            </div>
                            <div class="slide">
                                <div class="car-block">
                                    <div class="img-flex"> <a href="Super"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="My_images/Similar_trucks/super-hd-1.jpg" alt="" class="img-responsive"> </div>
